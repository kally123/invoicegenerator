...
import com.mc.invoice.service.impl.CustomerServiceImpl;
...
privileged aspect CustomerServiceImpl_Roo_Service_Impl {
     ...
     * @return Page
     */
    public Page<Customer> CustomerServiceImpl.findByCustomerBooking(CustomerBooking customerBooking, GlobalSearch globalSearch, Pageable pageable) {
     ...
     * @return Long
     */
    public long CustomerServiceImpl.countByCustomerBooking(CustomerBooking customerBooking) {
