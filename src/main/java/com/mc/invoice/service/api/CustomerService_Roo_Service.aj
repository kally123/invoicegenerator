...
privileged aspect CustomerService_Roo_Service {
     ...
     * @return Page
     */
    public abstract Page<Customer> CustomerService.findByCustomerBooking(CustomerBooking customerBooking, GlobalSearch globalSearch, Pageable pageable);
     ...
     * @return Long
     */
    public abstract long CustomerService.countByCustomerBooking(CustomerBooking customerBooking);
