...
import com.mc.invoice.config.SpringDataJpaDetachableRepositoryConfiguration;
...
privileged aspect SpringDataJpaDetachableRepositoryConfiguration_Roo_Jpa_Repository_Configuration {
    ...
    declare @type: SpringDataJpaDetachableRepositoryConfiguration: @EnableJpaRepositories(repositoryBaseClass = DetachableJpaRepositoryImpl.class, basePackageClasses = InvoiceGeneraorApplication.class);
