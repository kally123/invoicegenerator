...
/**
 * = AccomidationsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = AccomidationsItemThymeleafController.class)
@Component
public class AccomidationsItemThymeleafLinkFactory implements MethodLinkFactory<AccomidationsItemThymeleafController> {
	 ...
	 * @return Class
	 */
	public Class<AccomidationsItemThymeleafController> getControllerClass() {
		return AccomidationsItemThymeleafController.class;
	}
