...
public class AccomidationsItemJsonController {
	...
	public static UriComponents showURI(Accomidation accomidation) {
		return MvcUriComponentsBuilder
				.fromMethodCall(MvcUriComponentsBuilder.on(AccomidationsItemJsonController.class).show(accomidation))
	...
	public ResponseEntity<?> update(@ModelAttribute Accomidation storedAccomidation,
			@Valid @RequestBody Accomidation accomidation, BindingResult result) {
		if (result.hasErrors()) {
