...
/**
 * = AccomidationsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = AccomidationsCollectionThymeleafController.class)
@Component
public class AccomidationsCollectionThymeleafLinkFactory implements MethodLinkFactory<AccomidationsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<AccomidationsCollectionThymeleafController> getControllerClass() {
