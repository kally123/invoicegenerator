    ...
    public void addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        try {
            if (columnName.equals("id")) {
                ...
                builder.addColumn(getMessageSource().getMessage("label_customer_mobilenumber", null, "Mobile Number", locale), "mobileNumber", String.class.getName(), 100);
            } else if (columnName.equals("dateOfBirth")) {
                builder.addColumn(getMessageSource().getMessage("label_customer_dateofbirth", null, "Date Of Birth", locale), "dateOfBirth", String.class.getName(), 100);
            } else if (columnName.equals("emailId")) {
                builder.addColumn(getMessageSource().getMessage("label_customer_emailid", null, "Email Id", locale), "emailId", String.class.getName(), 100);
            } else if (columnName.equals("documentProof")) {
                builder.addColumn(getMessageSource().getMessage("label_customer_documentproof", null, "Document Proof", locale), "documentProof", String.class.getName(), 100);
            } else if (columnName.equals("addressLine1")) {
                builder.addColumn(getMessageSource().getMessage("label_customer_addressline1", null, "Address Line 1", locale), "addressLine1", String.class.getName(), 100);
            } else if (columnName.equals("addressLine2")) {
                builder.addColumn(getMessageSource().getMessage("label_customer_addressline2", null, "Address Line 2", locale), "addressLine2", String.class.getName(), 100);
            } else if (columnName.equals("cityName")) {
                builder.addColumn(getMessageSource().getMessage("label_customer_cityname", null, "City Name", locale), "cityName", String.class.getName(), 100);
            } else if (columnName.equals("country")) {
                builder.addColumn(getMessageSource().getMessage("label_customer_country", null, "Country", locale), "country", String.class.getName(), 100);
            }
